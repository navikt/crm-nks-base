...
export default class QuickChoiceCpe extends LightningElement {
    ...
    @track inputValues = {
        ...
        value: {
            ...
            valueDataType: null,
            isCollection: false,
            label: 'Value (Default or Existing)'
        },
        style_width: {
            value: null,
            valueDataType: null,
        ...
        navOnSelect: {
            ...
            valueDataType: null,
            isCollection: false,
            label: 'InstantNavigation Mode'
        },
        choiceIcons: {
            value: null,
            valueDataType: null,
            isCollection: true,
            label: 'Choice Icons [Card Icons]'
        },
        iconSize: {
            value: null,
            valueDataType: null,
        ...
        recordTypeId: {
            ...
            valueDataType: null,
            isCollection: false,
            label: 'Filter on Record Type ID:'
        },
        choiceLabels: {
            value: null,
            valueDataType: null,
            isCollection: true,
            label: 'Choice Labels [Card Titles]'
        },
        choiceValues: {
            value: null,
            valueDataType: null,
    ...
    selectDataSourceOptions = [
        ...
        {
            label: 'Two String Collections (Labels and Values)',
            value: this.settings.inputModeDualCollection
        },
        {
            label: 'One String Collection (Values)',
            value: this.settings.inputModeSingleCollection
        }
    ];
