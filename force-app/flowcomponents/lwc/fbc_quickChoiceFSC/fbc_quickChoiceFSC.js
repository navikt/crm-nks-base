...
export default class QuickChoiceFSC extends LightningElement {
    ...
    get gridClass() {
        return this.dualColumns
            ? 'slds-form-element__control slds-grid slds-gutters_medium slds-wrap slds-grid_vertical-align-center'
    ...
    get columnClass() {
        return this.dualColumns
            ? 'slds-visual-picker slds-visual-picker_vertical slds-col slds-size_1-of-2'
            : 'slds-visual-picker slds-visual-picker_vertical';
    }
